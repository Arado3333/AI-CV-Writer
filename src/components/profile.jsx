...
import { Card, CardContent, Avatar, Divider, Typography } from "@mui/material";
...
const fetchProfileData = async () => {
    try {
        const response = await fetch(
            `resumeData.json?timestamp=${new Date().getTime()}`
        );
                        ...
                        <TimelineItem key={index}>
                            ...
                            <TimelineContent>
                                <Typography variant="h6">
                                    {job.position || "No position found"}
                                </Typography>
                                <Typography
                                    variant="body2"
                                    color="text.secondary"
